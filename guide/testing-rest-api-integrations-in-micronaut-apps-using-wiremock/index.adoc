...
== Getting Started
You can create a new Micronaut project from https://micronaut.io/launch
[Micronaut Launch] by selecting the *http-client*, *micronaut-test-rest-assured*, and *testcontainers* features.
